...
class Newplayers : InventoryBuilder("§0▷ Выбор класса", 54) {
    ...
    fun openInventory(): Inventory {
        ...
        map[21] = createItemStack(
            "§9Порядок", lore(
                arrayOf(
                    ...
                    "&c ‣ &7Увеличенную скорость бега на 5% + 5% за лвл  ", "&c ‣ &7Уникальные предметы и оружия  ", ""
                )
        ...
        map[23] = createItemStack(
            "§4Сила", lore(
                arrayOf(
                    "", "&c ‣ &7Магия &4Силы &7даёт вам:", "&c ‣ &7Увеличенный урон на 0.5 + 0.1 за лвл ",
                    "&c ‣ &7Уникальные предметы и оружия  ", ""
                )
        ...
        map[25] = createItemStack(
            "§8Смерть", lore(
                arrayOf(
                    ...
                    "&c ‣ &7сохранить 30+уровень% инвентаря.  ", "&c ‣ &7Шанс игнора всех магий 75+lvl%.", ""
                )
