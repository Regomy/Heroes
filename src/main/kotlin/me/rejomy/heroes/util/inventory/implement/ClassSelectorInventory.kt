...
class ClassSelectorInventory : InventoryBuilder("§0▷ Выбор класса", 54) {
    ...
    fun openInventory(): Inventory {
        ...
        map[21] = createItemStack(
            ...
            arrayOf(
                ...
                "&c ‣ &7Увеличенную скорость бега на 5% + 5% за лвл  ",
                "&c ‣ &7в бою шанс 10+лвл% получить ускорение. ",
                "&c ‣ &7Уникальные предметы и оружия  ",
                ""
        ...
        map[23] = createItemStack(
            "§4Сила", lore(
                arrayOf(
                    ...
                    "&c ‣ &7Увеличенный урон на 0.01 + 0.01 за лвл ",
                    "&c ‣ &7Шанс (20 + lvl/10)% умножить урон на 1.1 + lvl/10.",
